          ...
          if (widget.booking.checkedIn &&
            ...
            Row(
              children: [
                ...
                AppText(
                  text:
                      "Checked in at ${DateFormat('h:mm a').format(widget.booking.checkedInAt!)}",
                  textStyle: TextStyle(
                    fontSize: 11,
                    fontWeight: FontWeight.w600,
                    color: AppColors.primaryDarkGreen,
                      ...
                      child: Column(
                        children: [
                          PaymentRow(
                            ...
                            value:
                                "₹${(widget.ticket.price - 25).toStringAsFixed(0)}",
                          ),
                          const RowDivider(),
                          const PaymentRow(
                            label: "Platform Fee",
